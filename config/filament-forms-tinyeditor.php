...
return [
    ...
    */
    ...
    'profiles' => [
        ...
        'default' => [
            'plugins' => 'advlist autoresize codesample code directionality emoticons fullscreen hr image imagetools link lists media table toc wordcount',
            'toolbar' => 'undo redo removeformat | formatselect fontsizeselect | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist | forecolor backcolor | blockquote table toc hr | image link media codesample code emoticons | wordcount fullscreen',
